...
return hackerrankOpenPromise;
   ...
   const emailIsEnterred = page.type("input[id='input-1']", email, {delay:50});
   return emailIsEnterred;
    // console.log("hackerank reached");
}).then(function(){
    const passwordIsEnterred = page.type("input[id='input-2']", password, {delay:50});
    return passwordIsEnterred;
}).then(function(){
    const loginclickedPromise = page.click("button[data-analytics='LoginPassword']", {delay:50});
   ...
   return warmupCheckboxPromise;
    ...
    const getAllQuestionPromise = page.$$("div.challenge-submit-btn", {delay:50});
...
function questionSolver(page, question, answer){
    return new Promise(function(resolve, reject){
        ...
        .then(function(){
            console.log("type")
            return page.type("div.custom-input.theme-old.size-medium", answer, {delay:50});
        }).then(function(){
